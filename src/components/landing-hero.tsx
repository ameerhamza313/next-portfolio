        ...
        <div className="mx-auto max-w-7xl">
          <AnimatePresence>
            <FadeUp key="title-main" duration={0.6}>
              <h1 className="bg-accent bg-clip-text py-2 text-4xl font-bold text-transparent sm:text-5xl md:text-6xl xl:text-7xl">
                Ameerhamza Sanadi
              </h1>
              <span className="text-xl font-semibold text-zinc-900 dark:text-zinc-100 md:text-4xl">
                Software Developer
              </span>
            </FadeUp>
